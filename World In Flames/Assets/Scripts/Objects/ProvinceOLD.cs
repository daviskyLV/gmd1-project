...
public class ProvinceOLD
{
    ...
    /// </summary>
    public ProvinceOLDColor ColoringType { get; private set; }
    /// <summary>
    ...
    public ProvinceOLD(Vector2Int position, float height, float humidity, float heat, Color defaultColor, ProvinceOLDColor coloringType, bool water, Nation owner = null)
    {
        Position = position;
    ...
    public void SetOwner(Nation owner)
    {
        ...
        if (ColoringType == ProvinceOLDColor.OwnerColor)
        {
            ColorChanged?.Invoke();
            if (owner != null)
            {
    ...
    {
        if (ColoringType == ProvinceOLDColor.ColorOverride || Owner == null)
